 ...
 */
final class Version20200605214213 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__hotel AS SELECT id, group_id, name, address FROM hotel');
        $this->addSql('DROP TABLE hotel');
        $this->addSql('CREATE TABLE hotel (id CHAR(36) NOT NULL COLLATE BINARY --(DC2Type:uuid)
        ...
        $this->addSql('INSERT INTO hotel (id, group_id, name, address) SELECT id, group_id, name, address FROM __temp__hotel');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , name VARCHAR(50) NOT NULL, address VARCHAR(255) DEFAULT NULL, group_id CHAR(36) DEFAULT \'NULL --(DC2Type:uuid)\' COLLATE BINARY --(DC2Type:uuid)
        , PRIMARY KEY(id))');
        $this->addSql('INSERT INTO hotel (id, group_id, name, address) SELECT id, group_id, name, address FROM __temp__hotel');
        $this->addSql('DROP TABLE __temp__hotel');
        $this->addSql('CREATE INDEX IDX_3535ED9FE54D947 ON hotel (group_id)');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__review AS SELECT id, hotel_id, score, comment FROM review');
        $this->addSql('DROP TABLE review');
        $this->addSql('CREATE TABLE review (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, score INTEGER NOT NULL, comment VARCHAR(255) DEFAULT NULL, hotel_id CHAR(36) DEFAULT \'NULL --(DC2Type:uuid)\' COLLATE BINARY --(DC2Type:uuid)
        )');
        $this->addSql('INSERT INTO review (id, hotel_id, score, comment) SELECT id, hotel_id, score, comment FROM __temp__review');
        $this->addSql('DROP TABLE __temp__review');
        $this->addSql('CREATE INDEX IDX_794381C63243BB18 ON review (hotel_id)');
